...
{
	[CreateAssetMenu(fileName = "SpriteImageColVFX", menuName = "HHUI Toolkit/Visual Effects/Colour/Sprite or Image Colour VFX", order = 1)]
	[DropdownMenuName("Colour/Sprite or Image Colour VFX")]
